        ...
        <div class="card-body">
            ...
            <form class="forms-sample" id="saleForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" value="{{$sale->created_at}}">
                </div>
                <div class="form-group">
                    <select name="customer_id" class="form-control SlectBox">
                        <option value="{{$sale->customer_id->name}}" selected disabled>Select Customer</option>
                ...
                <div class="genralTable">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td contenteditable="true" value="{{$sale->quantity}}" class="quantity" data-name="quantity">1</td>
                                <td contenteditable="true" value="{{$sale->description}}" data-name="description"></td>
                                <td contenteditable="true" value="{{$sale->unit_price}}" class="unit" data-name="unit_price">0</td>
                                <td class="subtotal" value="{{$sale->subtotal}}" data-name="subtotal">0.0</td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="genaralInput">
                            Order Discount : <input value="{{$sale->discount}}" type="text" name="discount" class="input" id="orderDiscount" value="0.0" oninput="calculateTotal()" />
                            Order Tax : <input value="14" type="text" class="input" id="orderTax" value="0.0" oninput="calculateTotal()" />
                        </div>

                        <div class="subtotal-total">
                        Grand Total : <span value="{{$sale->grand_total}}" name="grand_total" id="grandTotal">0.0</span>
                        </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea wire:model="notes" value="{{$sale->notes}}" name="notes" class="form-control" rows="5" placeholder="please add notes(if any)"></textarea>
                      </div>
                            
                      <button type="submit" class="btn btn-primary mr-2" id="editForm">Update Sale</button>
