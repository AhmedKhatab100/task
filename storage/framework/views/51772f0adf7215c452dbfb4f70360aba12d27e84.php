        ...
        <div class="card-body">
            ...
            <form class="forms-sample" id="saleForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" value="<?php echo e(date('Y-m-d H:i')); ?>">
                </div>
                <div class="form-group">
...
$("tbody tr").each(function() {
    ...
    saleData.items.push(item);
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('sales.store')); ?>", // استبدل بمسار حفظ البيانات في الخادم
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\resources\views/dashboard/sale/add.blade.php ENDPATH**/ ?>