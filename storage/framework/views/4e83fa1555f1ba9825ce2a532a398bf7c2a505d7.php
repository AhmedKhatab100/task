...
.text-center img  {
        ...
        <div class="box">
         ...
         <div class="container"> 
          <div class="form"> 
            ...
            <p>Don't have an account <a href="<?php echo e(route('get.admin.register')); ?>">Sign up</a></p>
          </div>
        </div>
 ...
 <?php /**PATH C:\xampp\htdocs\pro\resources\views/dashboard/login.blade.php ENDPATH**/ ?>