...
<html lang="en" class="loading">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(asset('dashboard_files/cssbundle/daterangepicker.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('dashboard_files/css/luno-style.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('dashboard_files/cssbundle/dropify.min.css')); ?>">
...
.text-center img  {
   ...
   <body>
    <section>
      ...
      <script src="<?php echo e(asset('dashboard_files/js/bundle/dropify.bundle.js')); ?>"></script>
 ...
 <?php /**PATH C:\xampp\htdocs\pro\resources\views/dashboard/register.blade.php ENDPATH**/ ?>